...
const CodeViewer = (_a) => {
    ...
    if (inline) {
        return (React.createElement("code", Object.assign({ className: cn(classes_1.Classes.RUNNING_TEXT, classes_1.Classes.CODE_BLOCK, classes_1.Classes.CODE_EDITOR, className, {
                isInline: inline,
                showLineNumbers,
            }) }, rest), value));
    }
    const markup = parseCode_1.parseCode(value, lang, showLineNumbers);
    return (React.createElement("pre", Object.assign({ className: cn(classes_1.Classes.RUNNING_TEXT, classes_1.Classes.CODE_BLOCK, classes_1.Classes.CODE_EDITOR, className, {
            isInline: inline,
            showLineNumbers,
